...
public class CueFinderTest extends TestCase
{
    ...
    public void test_MagicIslandParseRelNoFromName() throws Exception
    {
        String file_name = "Roger Shah presents Magic Island - Music for Balearic People Episode 119.mp3";
        MagicIslandParser cf = new MagicIslandParser( file_name );
        assertEquals( "119", cf.parse_release_no() );

        file_name = "Roger Shah - Magic Island - Music for Balearic People 120 - 2010-08-27.mp3";
        cf = new MagicIslandParser( file_name );
        assertEquals( "120", cf.parse_release_no() );
    ...
    public void test_ASOT_parse_name() throws Exception
    {
        String file_name = "Armin Van Buuren - A state of Trance 471.mp3";
        ASOTParser cf = new ASOTParser( file_name );
        String rel_no = cf.parse_release_no();
